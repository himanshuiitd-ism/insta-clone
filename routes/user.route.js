...
import { profileEditLimiter, userApiLimiter } from "../middlewares/rateLimit.middleware.js";
...
router.route('/profile/edit').post(verifyJWT, upload.single('profilePicture'),
  profileEditLimiter, editProfile);
